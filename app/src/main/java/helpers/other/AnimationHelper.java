 ...
 */
public final class AnimationHelper extends Animation {
    ...
    private static final WeakHashMap<View, AnimationHelper> PROXIES =
            new WeakHashMap<View, AnimationHelper>();
     ...
     */
    public static AnimationHelper wrap(View view) {
        AnimationHelper proxy = PROXIES.get(view);
        // This checks if the proxy already exists and whether it still is the animation of the given view
        if (proxy == null || proxy != view.getAnimation()) {
            proxy = new AnimationHelper(view);
