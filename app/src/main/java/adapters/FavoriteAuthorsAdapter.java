...
public class FavoriteAuthorsAdapter extends RecyclerView.Adapter<FavoriteAuthorsAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<AuthorDetails> mDataSet;

    public FavoriteAuthorsAdapter(Context context, ArrayList<AuthorDetails> favoriteAuthors) {
